...
export class AppMenuComponent implements OnInit {
    ...
    //                 { label: 'Invoices', icon: PrimeIcons.LIST, routerLink: ['invoices'] },
    //                 { label: 'Invoices', icon: PrimeIcons.LIST, routerLink: ['invoices-user'] },
        ...
        const allMenuItems = [
            {
                ...
                items: [
                    ...
                    { label: 'Invoices', icon: PrimeIcons.LIST, routerLink: ['invoices'], roles: ['admin', 'manager'] },
                    ...
                    // { label: 'Products', icon: 'pi pi-fw pi-shopping-bag', routerLink: ['products'], roles: ['admin', 'user'] },
                ]
            },
        ];
